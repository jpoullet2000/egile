#!/usr/bin/env python3
"""
Test the improved expensive/cheap product functionality with specific product types
"""
...
def test_improved_search_patterns():
    """Test the improved intent analysis for specific product type queries"""
    ...
    test_messages = [
        ...
        "cheapest products",  # General query (should use list_products)
    ]
